                ...
                <tr key={v.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-colors">
                  ...
                  <td className="px-4 py-3 text-right font-black text-emerald-600 dark:text-emerald-400">
                    {(() => {
                      ...
                      return v.cancelada ? <span className="text-red-500 line-through text-xs">R$ {displayTotal.toFixed(2)}</span> : `R$ ${displayTotal.toFixed(2)}`;
                    })()}
                  </td>
                  ...
                  {vendaSelecionada.itens.map(item => {
                    ...
                    return (
                      <tr key={item.id}>
                        ...
                        <td className="px-4 py-3 text-right">R$ {preco.toFixed(2)}</td>
                ...
                <span className="text-2xl font-black text-emerald-600 dark:text-emerald-400">
                  {(() => {
                    ...
                    if (vendaSelecionada.isOrcamento) {
                      ...
                      displayTotal = Math.max(0, sumBruto - vendaSelecionada.descontoFinal);
                    }
                    return `R$ ${displayTotal.toFixed(2)}`;
                  })()}
                </span>
              </div>
            </div>
